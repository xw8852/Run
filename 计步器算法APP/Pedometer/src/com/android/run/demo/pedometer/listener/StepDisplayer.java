...
import com.android.run.demo.pedometer.PedometerSettings;
import com.android.run.demo.pedometer.Utils;

/**
 * StepDetector提供的重要步骤,通过当前步骤数到activity。
 * Counts steps provided by StepDetector and passes the current
 * step count to the activity.
 */
public class StepDisplayer implements IStepListener, SpeakingTimer.Listener {
