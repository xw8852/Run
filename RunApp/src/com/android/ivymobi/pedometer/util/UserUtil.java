...
public class UserUtil {
    ...
    public static final String getEmail() {
        return Controller.getApplication().getSharedPreferences("User", 0).getString("u_login_email", null);
    }
    ...
    public static final String getSession() {
        return Controller.getApplication().getSharedPreferences("User", 0).getString("u_login_sessoin", null);
    }

    public static final Mine getMine() {
        String json = Controller.getApplication().getSharedPreferences("User", 0).getString("u_Mine", null);
    ...
    public static final void saveMetaData(MetaData data) {
        SharedPreferences preferences = Controller.getApplication().getSharedPreferences("MetaData", 0);
        preferences.edit().putString("MetaData", new Gson().toJson(data)).commit();
    }

    public static final MetaData getMetaData() {
        String json = Controller.getApplication().getSharedPreferences("MetaData", 0).getString("MetaData", null);
        if (TextUtils.isEmpty(json) || json == null)
            return null;
