...
package com.android.ivymobi.pedometer.listener;
...
public class StepService extends Service {
    private static final String TAG = "com.android.ivymobi.pedometer.listener.StepService";
    public static final String ACTION_STEP = TAG + "ACTION_STEP";
     ...
     * TODO:在通知栏显示，当后台服务在运行的时候
     */
    private void showNotification() {
        /**
         * CharSequence text = getText(R.string.app_name); Notification
         * notification = new Notification(R.drawable.ic_notification, null,
         * System.currentTimeMillis()); notification.flags =
         * Notification.FLAG_NO_CLEAR | Notification.FLAG_ONGOING_EVENT; Intent
         * pedometerIntent = new Intent(); pedometerIntent.setComponent(new
         * ComponentName(this, Pedometer.class));
         * pedometerIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
         * PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
         * pedometerIntent, 0); notification.setLatestEventInfo(this, text,
